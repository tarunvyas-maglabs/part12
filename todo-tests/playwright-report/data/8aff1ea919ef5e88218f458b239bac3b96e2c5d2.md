...
- Name: todo-app.spec.js >> Todo App E2E Tests >> can add a new todo via UI
- Location: tests/todo-app.spec.js:18:7
...
Locator: getByText('Test todo 1782984038572')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Test todo 1782984038572')

```

```yaml
- heading "Todos" [level=1]
- textbox: Test todo 1782984038572
- button "Submit"
```
